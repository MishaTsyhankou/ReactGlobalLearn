...
// @ts-ignore
const AddMovieModal = ({ setIsOpen, modalTitle }) => {
        ...
        <>
            <div className={styles.modal__wrapper} onClick={() => setIsOpen(false)}>
                <div onClick={(e) => e.stopPropagation()} className={styles.modal__body}>
                    ...
                    {/* { setIsDelete && (
                        <>
                         <div className={styles.modal__header}>{modalTitle}</div>
                            <section className={styles.modal__content__row}>
                                <div className={styles.delete__modal__text}>Are you sure you want to delete this movie?</div>
